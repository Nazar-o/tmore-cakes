                    ...
                    <div>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center space-x-3">
                                ...
                                <a href="mailto:Tmore.debby@gmail.com" className="text-gray-300 hover:text-white transition-colors">
                        ...
                        {/* Instagram Link - Centered under contact */}
                        <div className="flex justify-center mt-6">
                            <a href="https://www.instagram.com/tmorescakes/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-yellow-400 transition-colors">
