...
export default function CakeForm() {
    ...
    return (
        <form id="order-form" onSubmit={handleSubmit} className="max-w-4xl mx-auto card">
                    <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-6 sm:mb-8 text-center text-[#2E2E2E]">Request Your Custom Cake</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
                <div>
                    ...
                    <input
                        ...
                        className="w-full px-4 py-3 text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#6B2E5F]/20 focus:border-[#6B2E5F]/30 transition-colors"
            ...
            <div className={`mb-6 sm:mb-8 ${!formData.size ? 'opacity-50 pointer-events-none' : ''}`}>
                <label className="block text-sm font-medium text-gray-700 mb-3">
                    ...
                    {formData.size === 'other' && (
                                        <span className="text-xs text-[#2E2E2E] font-medium block mt-1">⚠️ Price may vary based on size and complexity</span>
                    )}
                </label>
                        ...
                        {standardFlavors.map((flavor) => (
                            <label key={flavor} className={`flex items-center p-2 rounded ${!formData.size ? 'cursor-not-allowed' : 'cursor-pointer hover:bg-gray-50'}`}>
                                <input
                                    ...
                                    className="mr-3 w-4 h-4 text-[#6B2E5F] focus:ring-[#6B2E5F]/20 rounded"
                                />
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
                        {specialtyFlavors.map((flavor) => (
                            <label key={flavor} className={`flex items-center p-2 rounded ${!formData.size || formData.size === 'other' ? 'cursor-not-allowed' : 'cursor-pointer hover:bg-gray-50'}`}>
                                ...
                                />
                                <span className="text-sm text-gray-700">{flavor}</span>
                                <span className="text-xs text-gray-600 ml-2">(+$15)</span>
                            </label>
                        ))}
                    </div>
                </div>
                    ...
                    <div className="mt-4 bg-blue-50 border border-blue-200 rounded-lg p-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {formData.flavors.map((flavor) => (
                                <span
                                    key={flavor}
                                    className="inline-flex items-center px-3 py-1 rounded-full text-sm bg-gray-100 text-[#2E2E2E] border border-gray-200"
                                >
                                    {flavor}
            ...
            <div className="mb-6 sm:mb-8">
                ...
                <button
                    ...
                    className="w-full px-4 py-3 text-base border-2 border-dashed border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-[#6B2E5F]/20 focus:border-[#6B2E5F]/30 transition-colors hover:border-gray-400 hover:bg-gray-50 text-gray-700 font-medium"
                >
                ...
                {formData.inspirationPhotos.length > 0 && (
                    <div className="mt-3">
                        ...
                        <button
                            ...
                            className="mt-3 px-4 py-2 text-sm font-medium text-[#2E2E2E] hover:text-[#2E2E2E] border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
                        >
                            + Add More Photos
                        </button>
                    </div>
            ...
            <div className="text-center">
                <p className="text-sm text-gray-600 mb-4">
                    ...
                    <a href="/terms" target="_blank" rel="noopener noreferrer" className="text-[#2E2E2E] hover:text-[#6B2E5F] underline">
                        Terms & Conditions
                    </a>
                    .
                </p>
